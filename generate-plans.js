...
/* ============================================================
   ...
   1) Bakes active ppo_plans into compare-ppo-dental-plans.html
   2) Programmatically generates Delta Dental SEO spokes from
      Supabase: UC-campus student pages + per-city dentist pages
      under /dental-insurance/ppo-plans/delta-dental/, plus a
      sitemap. Every generator step is fail-safe: on any error it
      warns and the build continues with whatever exists.
   ============================================================ */
